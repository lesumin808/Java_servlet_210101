...
public class DBConnectionPool {
	...
	String username;
	String password;
	ArrayList<Connection> connList = new ArrayList<Connection>();//미리 여러개의 connection 요청 및 반납
